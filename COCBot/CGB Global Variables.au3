...
Global $NetGLoot, $NetELoot, $NetDELoot, $NetTrophy
Global $GBonusTotal, $EBonusTotal, $DBonusTotal
Global $FirstRun = 1
Global $GBonusTotal = 0
Global $EBonusTotal = 0
Global $DBonusTotal = 0
Global $ArmyECost = 0
Global $ArmyDCost = 0
...
Global $AttackTHType
Global $allTroops = False, $skipBase = False , $skipITBase = False
...
;Global $iWBWizTower
;Global $iWBXbow
Global $TroopGroup[10][4] = [["Pekk",9,25,-1],["Drag",8,20,-1],["Heal",7,14,-1],["Wiza",6,4,-1],["Ball",5,5,-1],["Giant",2,5,-1],["Wall",4,2,-1],["Gobl",3,1,-1],["Arch",1,1,9],["Barb",0,1,8]]
