...
;~ -------------------------------------------------------------
 $tabAttackAdv = GUICtrlCreateTabItem("Attack Adv.")
	...
	$grpAtkOptions = GUICtrlCreateGroup("Attack Options", $x - 20, $y - 20, 450, 100)
		...
		$lblMinDark = GUICtrlCreateLabel("Min. Dark Elixir :", $x + 210 , $y - 20, -1, 17, $SS_LEFT)
		$txtMinDark = GUICtrlCreateInput("1000", $x + 290, $y - 22, 40, 20, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			$txtTip = "Set the minimum amount of DE search. Never attack with less."
			GUICtrlSetLimit(-1, 4)
...
;			GUICtrlSetTip(-1, $txtTip)
	...
	Local $x = 30, $y = 260
	$grpAtkCombos = GUICtrlCreateGroup("Advanced Attack Combo's", $x - 20, $y - 20, 225, 240)
		...
		$txtTHaddtiles = GUICtrlCreateInput("1", $x + 95, $y, 35, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			...
			GUICtrlSetState(-1, $GUI_DISABLE)
		$y+=25
		$lblAttackTHType = GUICtrlCreateLabel("Attack Type:", $x - 15 , $y + 5, -1, 17, $SS_RIGHT)
		$cmbAttackTHType = GUICtrlCreateCombo("",  $x + 95, $y, 105, 21, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			...
			GUICtrlSetState(-1, $GUI_DISABLE)
		$y = 400
		$chkSpellNone = GUICtrlCreateCheckbox("Use Spell:", $x - 5, $y, -1, -1)
		$txtTip = "Spells for use with TH Sniping"
		GUICtrlSetTip(-1, $txtTip)
		GUICtrlSetState(-1, $GUI_DISABLE)
		GUICtrlSetOnEvent(-1, "chkSpellNone")
		$cmbTHSpellType = GUICtrlCreateCombo("", $x + 95, $y, 105, 21, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
		GUICtrlSetData(-1, "1:Lighting|2:Healing|3:Rage", "2:Healing")
		GUICtrlSetState(-1, $GUI_DISABLE)
		$y = 425
		$lblAttackBottomType = GUICtrlCreateLabel("Attack Bottom base:", $x -15 , $y + 5, -1, 17, $SS_RIGHT)
		$cmbAttackbottomType = GUICtrlCreateCombo("",  $x + 95, $y, 105, 21, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			GUICtrlSetData(-1, "1:ModerateZoomed|2:SideAttack", "2:SideAttack")
			GUICtrlSetOnEvent(-1, "cmbAttackbottomType")
			GUICtrlSetState(-1, $GUI_DISABLE)
		$y = 450
		$lblDetectTrapedTH = GUICtrlCreateLabel("Detect Traped TH:", $x - 15 , $y + 5, -1, 17, $SS_RIGHT)
		$cmbDetectTrapedTH = GUICtrlCreateCombo("",  $x + 95, $y, 105, 21, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
		GUICtrlSetData(-1, "1:Dont Detect|2:Attack|3:Skip base", "3:Skip base")
