...
Local $x = 30, $y = 150
	...
	Local $x = 30, $y = 205
	$grpControls = GUICtrlCreateGroup("Recommended Settings", $x - 20, $y - 20, 450, 65)
		$lblRecSetting = GUICtrlCreateLabel("Current Settings:", $x + 10, $y + 9, -1, -1)
		$cmbRecSetting = GUICtrlCreateCombo("Custom", $x + 100, $y + 7, 230, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
		$txtTip = "Use these options to set the Recommended Settings"
		GUICtrlSetTip(-1, $txtTip)
		GUICtrlSetData(-1, "Townhall Snipe |TownHall 8 (Gold + Elixir) |TownHall 8 (Gold + Elixir + Dark Elixir)|TownHall 8 (Dark Elixir)|TownHall 9 (Gold + Elixir) |TownHall 9 (Gold + Elixir + Dark Elixir) |TownHall 9 (Dark Elixir) |TownHall 10 (Gold + Elixir) |TownHall 10 (Gold + Elixir + Dark Elixir) |TownHall 10 (Dark Elixir)", "Custom")
		GUICtrlSetOnEvent (-1 , "cmbRecSetting")
		$btnConfirmRecSetting = GUICtrlCreateButton ("Confirm", $x + 350, $y + 1, 65,35)
