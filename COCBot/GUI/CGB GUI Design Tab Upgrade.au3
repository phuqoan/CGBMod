...
Local $x = 30, $y = 150
	$Laboratory = GUICtrlCreateGroup("Laboratory", $x - 20, $y - 20, 298, 70)
		...
		$lblNextUpgrade = GUICtrlCreateLabel("Next do:", $x + 40, $y + 19 , -1, -1)
			GUICtrlSetState(-1, $GUI_DISABLE)
		$cmbLaboratory = GUICtrlCreateCombo("", $x + 90, $y + 16, 125, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
		...
		$icnLabUpgrade = GUICtrlCreateIcon($pIconLib, $eIcnLaboratory, $x + 235, $y, 32, 32)
	...
	Local $x = 267, $y = 150
		$Heroes = GUICtrlCreateGroup("Heroes", $x + 43 , $y - 20, 150, 70)
		$chkUpgradeKing = GUICtrlCreateCheckbox("Upgrade King", $x + 85, $y - 5, -1, -1)
		...
		$chkUpgradeQueen = GUICtrlCreateCheckbox("Upgrade Queen", $x + 85, $y + 20, -1, -1)
		...
		GUICtrlCreateIcon($pIconLib, $eIcnKing, $x + 55, $y - 4, 21, 21)
		GUICtrlCreateIcon($pIconLib, $eIcnQueen, $x + 55, $y + 20, 21, 21)
		GUICtrlCreateGroup("", -99, -99, 1, 1)
