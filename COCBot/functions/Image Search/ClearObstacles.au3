...
Func ClearObstacles()
	...
	If $ichkObstacles <> 1 Then Return False
	...
	$obstacles[2] = @ScriptDir & "\images\obstacles\" & string($ObsFolder) & "\vtrunk.bmp"
	$obstacles[3] = @ScriptDir & "\images\obstacles\" & string($ObsFolder) & "\htrunk.bmp"
	$obstacles[4] = @ScriptDir & "\images\obstacles\" & string($ObsFolder) & "\mushroom.bmp"
	;$obstacles[5] = @ScriptDir & "\images\obstacles\" & string($ObsFolder) & "\tree.bmp"
	;$obstacles[6] = @ScriptDir & "\images\obstacles\" & string($ObsFolder) & "\mtree.bmp"
	;$obstacles[7] = @ScriptDir & "\images\obstacles\" & string($ObsFolder) & "\btree.bmp"
