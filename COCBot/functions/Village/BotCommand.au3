...
Func BotCommand()
	If $iChkBotStop = 1 Then
		...
		If $icmbBotCond = 14 And $icmbHoursStop <> 0 Then $TimeToStop = $icmbHoursStop * 3600000 ; 3600000 = 1 Hours
		...
		If $MeetCondStop Then
			If $icmbBotCond <> 4 And $icmbBotCond <> 5 And $icmbBotCond <> 10 And $icmbBotCond <> 11 And $icmbBotCond <> 12 Then
